...
class TikTokManualCollector:
    ...
    def save_video(
        ...
        try:
            ...
            try:
                ...
                existing = db.query(TikTokVideo).filter(TikTokVideo.id == video_id).first()
                if not existing:
    ...
    def record_manual_observation(
        ...
        try:
            ...
            logger.info(f"Recorded manual observation for TikTok video {video_id}: {data}")
            return True
        except Exception as e:
...
def sample_manual_collection():
    ...
    if os.path.exists(sample_video_path):
        ...
        if saved_path:
            ...
            collector.record_manual_observation(
                video_id, 
                {
                    ...
                    "visual_elements": ["person showing herbs", "testimonial text overlay"],
        ...
        logger.info("In real usage, you would download a TikTok video and provide its path")
